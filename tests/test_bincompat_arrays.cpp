...
TEST_CASE("compare to python: byte array", "[bitpacker::binary_compat]")
{
    testPackAgainstPython(BP_STRING("r8"), std::array<bitpacker::byte_type, 1>{'g'});
}

TEST_CASE("compare to python: byte arrays", "[bitpacker::binary_compat]")
{
...
TEST_CASE("compare to python: text arrays", "[bitpacker::binary_compat]")
{
...
TEST_CASE("compare to python: text arrays mixed with integers", "[bitpacker::binary_compat]")
{
